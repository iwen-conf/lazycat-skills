...
- [ ] Multilingual copy, if provided, covers the default language with a clear fallback strategy. Runtime Chinese UI is recommended when useful for the target users, but is not a release blocker by itself.

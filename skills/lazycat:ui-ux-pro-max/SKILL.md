...
本技能的 UI/UX 检索数据是本地设计知识库。若问题涉及 Lazycat 官方事实，例如商店截图要求、提审规则、AI App 入口、应用元数据或平台集成约束，必须先通过 OpenViking 查询官方文档：

```bash
ov find "store screenshots submission metadata AI App platform integration" --uri viking://resources/lazycat-developer-docs -n 5
```
...
```bash
python3 lazycat:ui-ux-pro-max/scripts/search.py "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python3 lazycat:ui-ux-pro-max/scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python3 lazycat:ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name"
```
...
```bash
python3 lazycat:ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --page "dashboard"
```
...
```bash
python3 lazycat:ui-ux-pro-max/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 lazycat:ui-ux-pro-max/scripts/search.py "beauty spa wellness service elegant" --design-system -p "Serenity Spa"
```
...
python3 lazycat:ui-ux-pro-max/scripts/search.py "animation accessibility" --domain ux

# Get alternative typography options if needed
python3 lazycat:ui-ux-pro-max/scripts/search.py "elegant luxury serif" --domain typography
```
...
python3 lazycat:ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system

# Markdown - best for documentation
python3 lazycat:ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system -f markdown
```
